...
import { LayoutGrid, MessageSquareText, ClipboardList, Users, History, ShieldCheck, LogOut } from 'lucide-react'
import Logo from '../components/Logo'
import { useAuth } from '../hooks/useAuth'

const links = [
  { to: '/patient/dashboard', label: 'Dashboard', icon: LayoutGrid },
  { to: '/patient/intake', label: 'New Concern', icon: MessageSquareText },
  { to: '/patient/review', label: 'Review', icon: ClipboardList },
  { to: '/patient/matching', label: 'Find Care', icon: Users },
